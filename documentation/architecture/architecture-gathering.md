...
- Visual mapping (default `resources/gathering-mapping-core.json`; world setting **Gathering Ruleset JSON**) remains orthogonal and drives spot appearance by biome/state/family.
