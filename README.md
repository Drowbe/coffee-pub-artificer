...
1. Inside Foundry VTT, use the following manifest URL:
   ```
   https://github.com/Drowbe/coffee-pub-artificer/releases/latest/download/module.json
   ```
...
Module settings can be found in: Configure Settings → Coffee Pub Artificer
